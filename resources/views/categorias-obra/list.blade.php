...
<div class="page-header">
    ...
    <div class="page-header-right">
        <a href="{{ url('/home') }}" class="btn-header btn-header-ghost">
            <i class="fas fa-arrow-left"></i> Voltar
        </a>
        <a href="{{ route('categorias-obra.create') }}" class="btn-header btn-header-primary">
...
<div class="filter-panel">
    <form method="GET" action="{{ route('categorias-obra.list') }}">
        <div class="row" style="margin: 0 -8px; align-items: flex-end;">
            ...
            <div class="col-md-2" style="padding: 0 8px;">
                <label class="filter-label" style="visibility:hidden;">.</label>
                <a href="{{ route('categorias-obra.list') }}" class="btn-clear">
...
<div class="table-card">
    <div class="table-card-header">
        ...
        <span class="table-count">
            @if($categorias->total() > 0)
                {{ $categorias->firstItem() }}–{{ $categorias->lastItem() }} de {{ $categorias->total() }}
            @else
                0 registros
            @endif
        </span>
    ...
    <div style="overflow-x: auto;">
        <table class="mat-table">
            ...
            <tbody>
                ...
                <tr>
                    <td><span class="chip chip-id">{{ $categoria->id }}</span></td>
                    <td><span class="chip chip-code">{{ $categoria->codigo }}</span></td>
                    <td><span class="mat-name">{{ $categoria->nome }}</span></td>
                    <td><span class="chip chip-order">{{ $categoria->ordem }}</span></td>
                    <td><span class="mat-desc">{{ $categoria->descricao ?? '—' }}</span></td>
                    <td>
                        <div class="action-group">
                            <a href="{{ route('categorias-obra.edit', $categoria->id) }}"
                               class="btn-icon btn-icon-edit" title="Editar">
                                <i class="fas fa-pencil-alt"></i>
                            </a>
                            <a href="{{ route('pdf.categoria', $categoria->id) }}"
                               target="_blank"
                            ...
                            <button type="button"
                                    ...
                                    onclick="confirmDelete({{ $categoria->id }}, '{{ addslashes($categoria->nome) }}')"
                                    title="Excluir">
    ...
    <div class="table-footer">
        <div class="pagination-info">
            ...
            Exibindo <strong>{{ $categorias->firstItem() }}</strong> a <strong>{{ $categorias->lastItem() }}</strong>
