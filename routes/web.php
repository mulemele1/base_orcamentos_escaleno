...
use App\Http\Controllers\{
    ...
    CategoriaObraController, // NOVO
    ItemOrcamentoController, // NOVO
    SummaryController,       // NOVO
};
...
// Gráficos (públicos? se não, adicionar middleware)
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::post('/participantes/carregar', [ParticipanteController::class, 'carregar'])->name('participantes.carregar');
    Route::post('/participantes/guardar', [ParticipanteController::class, 'guardar'])->name('participantes.guardar');
...
Route::prefix('itens-orcamento')->name('itens-orcamento.')->middleware(['auth'])->group(function () {
    ...
    Route::get('/{id}/duplicate', [ItemOrcamentoController::class, 'duplicate'])->name('duplicate'); // NOVA ROTA
