...
<?php $__env->startSection('title', 'Nova Subatividade'); ?>

<?php $__env->startSection('content_header'); ?>
<div class="d-flex justify-content-between align-items-center">
    <h1><i class="fas fa-plus-circle mr-2"></i>Nova Subatividade</h1>
    <a href="<?php echo e(route('subatividades.index', ['atividade_id' => $atividadeId])); ?>" class="btn btn-secondary">
...
<div class="row">
    <div class="col-md-8">
        <div class="card">
            ...
            <form action="<?php echo e(route('subatividades.store')); ?>" method="POST" id="subatividadeForm">
                <?php echo csrf_field(); ?>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4">
...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    <?php $__currentLoopData = $atividades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $atividade): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($atividade->id); ?>" 
                                            <?php echo e(old('atividade_id', $atividadeId) == $atividade->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" 
                                        ...
                                        required>
                                    <option value="">Selecione</option>
                                    <option value="m³" <?php echo e(old('unidade') == 'm³' ? 'selected' : ''); ?>>m³</option>
                                    <option value="m²" <?php echo e(old('unidade') == 'm²' ? 'selected' : ''); ?>>m²</option>
                                    <option value="m" <?php echo e(old('unidade') == 'm' ? 'selected' : ''); ?>>m (metro linear)</option>
                                    <option value="Un" <?php echo e(old('unidade') == 'Un' ? 'selected' : ''); ?>>Un (unidade)</option>
                                    <option value="Vg" <?php echo e(old('unidade') == 'Vg' ? 'selected' : ''); ?>>Vg (verba global)</option>
                                    <option value="kg" <?php echo e(old('unidade') == 'kg' ? 'selected' : ''); ?>>kg</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>" 
                                       ...
                                       value="<?php echo e(old('perda_percentual', 0)); ?>" 
                                       min="0" 
                                       max="100"
                                       step="0.1">
...
unset($__errorArgs, $__bag); ?>" 
                                               id="comprimento" 
                                               name="comprimento" 
                                               value="<?php echo e(old('comprimento')); ?>" 
                                               min="0"
                                               step="0.01">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\escaleno\Programacao\base_orcamentos_escaleno\resources\views/subatividades/create.blade.php ENDPATH**/ ?>