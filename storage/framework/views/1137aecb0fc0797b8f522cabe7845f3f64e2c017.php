...
<div class="page-header">
    <div class="page-header-left">
        ...
        <p>Gestão de materiais e insumos &mdash; <?php echo e($stats['total']); ?> itens cadastrados</p>
    </div>
    <div class="page-header-right">
        <a href="<?php echo e(route('materiais.export')); ?>" class="btn-header btn-header-ghost">
            <i class="fas fa-download"></i> Exportar
        </a>
        <a href="<?php echo e(route('materiais.create')); ?>" class="btn-header btn-header-primary">
...
<div class="stats-row">
    ...
    <div class="stat-card">
        ...
        <div class="stat-body">
            <div class="stat-value"><?php echo e(number_format($stats['total_categorias'], 0)); ?></div>
    ...
    <div class="stat-card">
        ...
        <div class="stat-body">
            <div class="stat-value" style="font-size:1.3rem;">MT <?php echo e(number_format($stats['valor_medio'], 2, ',', '.')); ?></div>
...
<div class="filter-panel">
    <form method="GET" action="<?php echo e(route('materiais.list')); ?>">
        <div class="row" style="gap: 0; margin: 0 -8px;">
            ...
            <div class="col-md-3" style="padding: 0 8px;">
                ...
                <select class="filter-control" name="ordenar_por" id="ordenarPor">
                    <option value="categoria"   <?php echo e(request('ordenar_por') == 'categoria'   ? 'selected' : ''); ?>>Categoria</option>
                    <option value="nome"        <?php echo e(request('ordenar_por') == 'nome'        ? 'selected' : ''); ?>>Nome</option>
                    <option value="codigo"      <?php echo e(request('ordenar_por') == 'codigo'      ? 'selected' : ''); ?>>Código</option>
                    <option value="valor_compra"<?php echo e(request('ordenar_por') == 'valor_compra'? 'selected' : ''); ?>>Valor</option>
                </select>
            </div>
...
<div class="table-card">
    <div class="table-card-header">
        ...
        <span class="table-count">
            <?php if($materiais->total() > 0): ?>
                <?php echo e($materiais->firstItem()); ?>–<?php echo e($materiais->lastItem()); ?> de <?php echo e($materiais->total()); ?>
    ...
    <div style="overflow-x: auto;">
        <table class="mat-table">
            ...
            <tbody>
                ...
                <tr>
                    <td><span class="chip chip-id"><?php echo e($material->id); ?></span></td>
                    <td><span class="chip chip-code"><?php echo e($material->codigo); ?></span></td>
                    <td><span class="mat-name"><?php echo e($material->nome); ?></span></td>
                    <td><span class="chip chip-unit"><?php echo e($material->unidade); ?></span></td>
                    <td><span class="val-main">MT <?php echo e($material->valor_compra_formatado); ?></span></td>
                    <td style="color: var(--ink-muted);"><?php echo e($material->rendimento_formatado); ?></td>
                    <td>
                        <?php if($material->rendimento > 0): ?>
                            <span class="val-main">
                                MT <?php echo e(number_format($material->valor_compra / $material->rendimento, 2, ',', '.')); ?>

                            </span>
                            <span class="val-unit">/<?php echo e($material->unidade); ?></span>
                        <?php else: ?>
                            <span style="color: var(--ink-muted);">—</span>
                        <?php endif; ?>
                    </td>
                    <td><span class="chip chip-cat"><i class="fas fa-tag" style="font-size:.7rem;"></i> <?php echo e($material->categoria); ?></span></td>
                    <td>
                        <div class="action-group" style="justify-content:center;">
                            ...
                            <button type="button"
                                    ...
                                    onclick="confirmDelete(<?php echo e($material->id); ?>, '<?php echo e(addslashes($material->nome)); ?>')"
                                    title="Excluir">
                ...
                <tr>
                    <td colspan="9">
                        <div class="empty-state">
                            ...
                            <a href="<?php echo e(route('materiais.create')); ?>" class="btn-empty">
    ...
    <?php if($materiais->hasPages()): ?>
    <div class="table-footer">
        <div class="pagination-info">
            <i class="fas fa-list mr-1"></i>
            Exibindo <strong><?php echo e($materiais->firstItem()); ?></strong> a <strong><?php echo e($materiais->lastItem()); ?></strong>
            de <strong><?php echo e($materiais->total()); ?></strong> registros
        </div>
        <div>
            <?php echo e($materiais->appends(request()->query())->links()); ?>
    ...
    function confirmDelete(id, nome) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                form.method = 'POST';
                form.action = '<?php echo e(route("materiais.destroy", "")); ?>/' + id;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\escaleno\Programacao\base_orcamentos_escaleno\resources\views/materiais/list.blade.php ENDPATH**/ ?>