...
<div class="cat-grid">
    ...
    <a href="<?php echo e(route('itens-orcamento.list', ['categoria_id' => $categoria->id])); ?>" class="cat-card">
        <div class="cat-icon-wrap">
            <i class="fas fa-building"></i>
        </div>
        <div class="cat-body">
            <p class="cat-name"><?php echo e($categoria->nome); ?></p>
            <p class="cat-desc"><?php echo e($categoria->descricao ?? 'Sem descrição disponível'); ?></p>
        </div>
        <div class="cat-footer">
            <span class="cat-code"><?php echo e($categoria->codigo); ?></span>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\escaleno\Programacao\base_orcamentos_escaleno\resources\views/itens-orcamento/selecionar-categoria.blade.php ENDPATH**/ ?>