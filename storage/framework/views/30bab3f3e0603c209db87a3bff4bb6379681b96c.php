...
<div style="padding: 28px 28px 4px;">
    <?php echo $__env->make('categorias-obra.partials.validations', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <div class="col-md-6" style="padding: 0 10px;">
            <div class="field-group">
                ...
                <input type="text"
                       id="codigo"
                       name="codigo"
                       value="<?php echo e(old('codigo', $categoria->codigo ?? '')); ?>"
                       class="field-input <?php $__errorArgs = ['codigo'];
        ...
        <div class="col-md-3" style="padding: 0 10px;">
            <div class="field-group">
                ...
                <input type="number"
                       id="ordem"
                       name="ordem"
                       value="<?php echo e(old('ordem', $categoria->ordem ?? '0')); ?>"
                       class="field-input <?php $__errorArgs = ['ordem'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="field-group">
        ...
        <input type="text"
               id="nome"
               name="nome"
               value="<?php echo e(old('nome', $categoria->nome ?? '')); ?>"
               class="field-input <?php $__errorArgs = ['nome'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                  placeholder="Descrição da categoria (opcional)"><?php echo e(old('descricao', $categoria->descricao ?? '')); ?></textarea>
...
<div class="meta-box">
    <div class="meta-item">
        ...
        <span><strong>Criado em:</strong> <?php echo e($categoria->created_at->format('d/m/Y H:i')); ?></span>
    </div>
    <div class="meta-item">
        <i class="far fa-clock"></i>
        <span><strong>Última atualização:</strong> <?php echo e($categoria->updated_at->format('d/m/Y H:i')); ?></span>
    </div>
</div>


<?php echo $__env->make('categorias-obra.partials.projetos_vinculados', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php endif; ?>
</div>

<div class="form-footer">
    <a href="<?php echo e(route('categorias-obra.list')); ?>" class="btn-cancel">
        <i class="fas fa-times"></i> Cancelar
    </a>
    <button type="submit" class="btn-save">
        <i class="fas fa-save"></i>
        <?php echo e(isset($categoria) && $categoria->id ? 'Atualizar Categoria' : 'Salvar Categoria'); ?>

    </button>
</div><?php /**PATH C:\Users\escaleno\Programacao\base_orcamentos_escaleno\resources\views/categorias-obra/partials/form.blade.php ENDPATH**/ ?>