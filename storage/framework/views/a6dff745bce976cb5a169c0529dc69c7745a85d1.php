    ...
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="<?php echo e(url('/projetos')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                  rows="4" 
                                  placeholder="Descreva o projeto..."><?php echo e(old('descricao')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                       step="0.01" 
                                       value="<?php echo e(old('contingencia', 8)); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group mt-3">
                        ...
                        <a href="<?php echo e(url('/projetos')); ?>" class="btn btn-secondary">
