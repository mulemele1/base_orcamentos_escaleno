...
<?php $__env->startSection('title', 'Orçamento ' . $orcamento->codigo); ?>

<?php $__env->startSection('content_header'); ?>
    <div class="d-flex justify-content-between align-items-center">
        <h1><i class="fas fa-file-invoice-dollar mr-2"></i>Orçamento: <?php echo e($orcamento->codigo); ?></h1>
...
<div>
    ...
    <a href="<?php echo e(route('orcamentos.pdf', $orcamento->id)); ?>" class="btn btn-danger">
    ...
    <a href="<?php echo e(route('projetos.show', $orcamento->projeto_id)); ?>" class="btn btn-secondary">
     ...
     <a href="<?php echo e(route('orcamentos.edit', $orcamento->id)); ?>" class="btn btn-primary">
    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-3">
                        <p><strong>Código:</strong> <?php echo e($orcamento->codigo); ?></p>
                        <p><strong>Versão:</strong> v<?php echo e($orcamento->versao); ?></p>
                    </div>
                    <div class="col-md-3">
                        <p><strong>Projeto:</strong> <?php echo e($orcamento->nome_projeto); ?></p>
                        <p><strong>Cliente:</strong> <?php echo e($orcamento->cliente); ?></p>
                    </div>
                    <div class="col-md-3">
                        <p><strong>Localização:</strong> <?php echo e($orcamento->localizacao); ?></p>
                        <p><strong>Data Emissão:</strong> <?php echo e($orcamento->data_emissao->format('d/m/Y')); ?></p>
                    </div>
                    <div class="col-md-3">
                        <p><strong>IVA:</strong> <?php echo e($orcamento->iva_percentual); ?>%</p>
                        <p><strong>Contingência:</strong> <?php echo e($orcamento->contingencia_percentual); ?>%</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-md-3">
        <div class="info-box bg-info">
            ...
            <div class="info-box-content">
                ...
                <span class="info-box-number">MT <?php echo e(number_format($orcamento->subtotal, 2, ',', '.')); ?></span>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="info-box bg-warning">
            ...
            <div class="info-box-content">
                <span class="info-box-text">IVA (<?php echo e($orcamento->iva_percentual); ?>%)</span>
                <span class="info-box-number">MT <?php echo e(number_format($orcamento->valor_iva, 2, ',', '.')); ?></span>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="info-box bg-warning">
            ...
            <div class="info-box-content">
                <span class="info-box-text">Contingência (<?php echo e($orcamento->contingencia_percentual); ?>%)</span>
                <span class="info-box-number">MT <?php echo e(number_format($orcamento->valor_contingencia, 2, ',', '.')); ?></span>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="info-box bg-success">
            ...
            <div class="info-box-content">
                ...
                <span class="info-box-number">MT <?php echo e(number_format($orcamento->grand_total, 2, ',', '.')); ?></span>
            </div>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <?php if(empty($dadosHierarquicos)): ?>
                ...
                <?php else: ?>
                    ...
                    <?php $__currentLoopData = $dadosHierarquicos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoriaId => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php 
                            $categoria = $data['categoria'];
                            $totalCategoria = collect($data['atividades'])->sum('subtotal');
                        ?>
                        <div class="accordion-categoria" data-categoria-id="<?php echo e($categoriaId); ?>">
                            <div class="categoria-header">
                                <h3>
                                    <i class="fas fa-chevron-right"></i>
                                    <span class="badge-categoria"><?php echo e($categoria->codigo); ?></span>
                                    <span class="categoria-nome editable" data-id="<?php echo e($categoria->id); ?>" data-tipo="categoria" data-campo="nome"><?php echo e($categoria->nome); ?></span>
                                </h3>
                                <div class="d-flex align-items-center gap-3">
                                    <div class="total">
                                        <span class="badge bg-success">MT <?php echo e(number_format($totalCategoria, 2, ',', '.')); ?></span>
                                    </div>
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-sm btn-light" onclick="editarInline(this, 'categoria', <?php echo e($categoria->id); ?>, 'nome')" title="Editar Nome">
                                            <i class="fas fa-edit"></i>
                                        </button>
                                        <button type="button" class="btn btn-sm btn-light" onclick="adicionarAtividadeModal(<?php echo e($categoria->id); ?>)" title="Adicionar Atividade">
                            ...
                            <div class="categoria-content">
                                <?php $__currentLoopData = $data['atividades']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $atividade): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php $totalAtividade = $atividade->subtotal ?: $atividade->total_calculado; ?>
                                    <div class="atividade-item">
                                        <div class="atividade-header">
                                            <h4>
                                                <i class="fas fa-chevron-right"></i>
                                                <span class="badge-atividade"><?php echo e($atividade->codigo); ?></span>
                                                <span class="atividade-nome editable" data-id="<?php echo e($atividade->id); ?>" data-tipo="atividade" data-campo="nome"><?php echo e($atividade->nome); ?></span>
                                                <span class="badge bg-secondary"><?php echo e($atividade->unidade); ?></span>
                                            </h4>
                                            <div class="d-flex align-items-center gap-3">
                                                <span class="total-atividade">MT <?php echo e(number_format($totalAtividade, 2, ',', '.')); ?></span>
                                                <span class="badge bg-secondary ml-2"><?php echo e($atividade->subatividades->count()); ?> itens</span>
                                                <div class="btn-group">
                                                    <button type="button" class="btn btn-sm btn-light" onclick="editarInline(this, 'atividade', <?php echo e($atividade->id); ?>, 'nome')" title="Editar Nome">
                                                        <i class="fas fa-edit"></i>
                                                    </button>
                                                    <button type="button" class="btn btn-sm btn-light" onclick="adicionarSubatividadeModal(<?php echo e($atividade->id); ?>)" title="Adicionar Subatividade">
                                                        <i class="fas fa-plus"></i>
                                                    </button>
                                                    <button type="button" class="btn btn-sm btn-danger" onclick="removerAtividade(<?php echo e($orcamento->id); ?>, <?php echo e($atividade->id); ?>)" title="Remover do Orçamento">
                                        ...
                                        <div class="atividade-content">
                                            <?php $__currentLoopData = $atividade->subatividades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subatividade): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="subatividade-card">
                                                    <div class="subatividade-header">
                                                        <div class="subatividade-info">
                                                            <span class="subatividade-codigo"><?php echo e($subatividade->codigo); ?></span>
                                                            <span class="subatividade-nome editable" data-id="<?php echo e($subatividade->id); ?>" data-tipo="subatividade" data-campo="nome"><?php echo e($subatividade->nome); ?></span>
                                                            <div class="subatividade-detalhes">
                                                                Quantidade: <span class="editable" data-id="<?php echo e($subatividade->id); ?>" data-tipo="subatividade" data-campo="quantidade_proposta"><?php echo e(number_format($subatividade->quantidade_proposta, 2, ',', '.')); ?></span> <?php echo e($subatividade->unidade); ?>

                                                                <?php if($subatividade->perda_percentual > 0): ?>
                                                                    <span class="text-warning ml-2">(+<span class="editable" data-id="<?php echo e($subatividade->id); ?>" data-tipo="subatividade" data-campo="perda_percentual"><?php echo e($subatividade->perda_percentual); ?></span>% perda)</span>
                                                                <?php endif; ?>
                                                            </div>
                                                        </div>
                                                        <div class="subatividade-valores">
                                                            <div class="subatividade-total">MT <?php echo e(number_format($subatividade->total, 2, ',', '.')); ?></div>
                                                            <div class="subatividade-unitario">Preço unitário: MT <?php echo e(number_format($subatividade->preco_unitario, 2, ',', '.')); ?></div>
                                                        </div>
                                                    </div>
                                                    <div class="subatividade-actions">
                                                        <button type="button" class="btn btn-sm btn-warning btn-icon-sm" onclick="editarInline(this, 'subatividade', <?php echo e($subatividade->id); ?>, 'nome')" title="Editar">
                                                            <i class="fas fa-edit"></i>
                                                        </button>
                                                        <button type="button" class="btn btn-sm btn-danger btn-icon-sm" onclick="excluirSubatividade(<?php echo e($subatividade->id); ?>)" title="Excluir">
                                                            <i class="fas fa-trash"></i>
                                                        </button>
                                                    </div>
                                                    
                                                    <?php if($subatividade->composicaoCustos->count() > 0): ?>
                                                        <div class="materiais-table">
                                                            <table class="table table-sm">
                                                                ...
                                                                <tbody>
                                                                    <?php $__currentLoopData = $subatividade->composicaoCustos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <?php
                                                                            $tipoClass = $comp->tipo == 'material' ? 'badge-material' : ($comp->tipo == 'mao_obra' ? 'badge-mao-obra' : 'badge-servico');
                                                                        ?>
                                                                         <tr>
                                                                             <td>
                                                                                <strong><?php echo e($comp->material->nome ?? 'Mão de Obra'); ?></strong>
                                                                                <?php if($comp->material): ?>
                                                                                    <br><small class="text-muted">Cód: <?php echo e($comp->material->codigo); ?></small>
                                                                                <?php endif; ?>
                                                                              </td>
                                                                            <td class="text-right editable" data-id="<?php echo e($comp->id); ?>" data-tipo="composicao" data-campo="quantidade"><?php echo e(number_format($comp->quantidade, 3, ',', '.')); ?></td>
                                                                            <td class="text-center"><?php echo e($comp->unidade); ?></td>
                                                                            <td class="text-right editable" data-id="<?php echo e($comp->id); ?>" data-tipo="composicao" data-campo="custo_unitario">MT <?php echo e(number_format($comp->custo_unitario, 2, ',', '.')); ?></td>
                                                                            <td class="text-right text-primary">MT <?php echo e(number_format($comp->custo_total, 2, ',', '.')); ?></td>
                                                                            <td class="text-center">
                                                                                <span class="<?php echo e($tipoClass); ?>"><?php echo e(ucfirst(str_replace('_', ' ', $comp->tipo))); ?></span>
                                                                             </td>
                                                                            <td class="text-center">
                                                                                <button type="button" class="btn btn-xs btn-danger" onclick="removerMaterial(<?php echo e($comp->id); ?>)">
                                                                                    <i class="fas fa-trash"></i>
                                                                                </button>
                                                                             </td>
                                                                          </tr>
                                                                ...
                                                                <tfoot>
                                                                     <tr class="bg-light">
                                                                        ...
                                                                        <td class="text-right"><strong>MT <?php echo e(number_format($subatividade->total, 2, ',', '.')); ?></strong></td>
                                                                        <td colspan="2"></td>
                                                                      </tr>
                                                                </tfoot>
                                                             </table>
                                                    ...
                                                    <?php else: ?>
                                                        <div class="alert alert-warning mb-0 py-2">
                                                            ...
                                                            <button type="button" class="btn btn-xs btn-primary ml-2" onclick="adicionarMaterialModal(<?php echo e($subatividade->id); ?>)">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <select name="categoria_obra_id" id="ativ_categoria_id" class="form-control" required>
                            <option value="">Selecione...</option>
                            <?php $__currentLoopData = $todasCategorias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($cat->id); ?>"><?php echo e($cat->codigo); ?> - <?php echo e($cat->nome); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div class="form-group">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <select name="atividade_id" id="sub_atividade_id" class="form-control" required>
                            <option value="">Selecione...</option>
                            <?php $__currentLoopData = $todasAtividades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $atv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($atv->id); ?>"><?php echo e($atv->categoriaObra->codigo); ?>.<?php echo e($atv->codigo); ?> - <?php echo e($atv->nome); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div class="form-group">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select name="material_id" id="mat_material_id" class="form-control" required>
                            <option value="">Selecione...</option>
                            <?php $__currentLoopData = $materiais ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($mat->id); ?>"><?php echo e($mat->codigo); ?> - <?php echo e($mat->nome); ?> (<?php echo e($mat->unidade); ?>)</option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div class="form-group">
...
$(document).ready(function() {
    ...
    $('#formAddCategoria').submit(function(e) {
        e.preventDefault();
        $.post('<?php echo e(route("categorias-obra.store")); ?>', $(this).serialize())
    ...
    $('#formAddAtividade').submit(function(e) {
        e.preventDefault();
        $.post('<?php echo e(route("atividades.store")); ?>', $(this).serialize())
            .done(() => location.reload())
            .fail(err => alert('Erro: ' + err.responseJSON?.message));
    });
    ...
    $('#formAddSubatividade').submit(function(e) {
        e.preventDefault();
        $.post('<?php echo e(route("subatividades.store")); ?>', $(this).serialize())
            .done(() => location.reload())
            .fail(err => alert('Erro: ' + err.responseJSON?.message));
    });
    ...
    $('#formAddMaterial').submit(function(e) {
        e.preventDefault();
        $.post('<?php echo e(route("composicoes.store")); ?>', $(this).serialize())
            .done(() => location.reload())
            .fail(err => alert('Erro: ' + err.responseJSON?.message));
    });
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\escaleno\Programacao\base_orcamentos_escaleno\resources\views/orcamentos/show.blade.php ENDPATH**/ ?>